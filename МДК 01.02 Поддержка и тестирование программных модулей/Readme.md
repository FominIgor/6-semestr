...
6. Ожидаемый результат: четное число 1 + четное число 2 = четная сумма чимсел
7. Фактический результат: четное число 1 + четное число 2 = нечетная сумма числе
8. Влияние: критичный дефект, сложение важная математическа операция.
