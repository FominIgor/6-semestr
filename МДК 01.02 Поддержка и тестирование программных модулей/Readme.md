...
Упражнение:
1. Идентификатор: 1
2. Краткое описание: Сложение четных числе происходит не верно
3. Подробне описание: В ходе сложения двух четных результат болше на 1, чем должно было быть
4. Шаги:
   Открыть калькулятор
   ...
   Нажатие на =
5. Ожидаемый результат: четное число 1 + четное число 2 = четная сумма чимсел
6. Фактический результат: четное число 1 + четное число 2 = нечетная сумма числе
7. Влияние: критичный дефект, сложение важная математическа операция.
